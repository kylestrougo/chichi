...
class PostForm(FlaskForm):
    post = TextAreaField('Here you can talk shit:', validators=[
...
class PlayerSelectionForm(FlaskForm):
    submit = SubmitField('Submit')
    player_selection = RadioField('Select Player', choices=[], coerce=int)
...
class TieBreakerForm(FlaskForm):
    single_number = IntegerField('Single Number', validators=[DataRequired(), NumberRange(min=1)])  # Adjust validators as needed
