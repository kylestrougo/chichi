...
def add_jobs():
    ...
    scheduler.add_job(id='refresh_scores', func=update_data, trigger='interval', minutes=30, start_date=t_start, end_date=end_dt_d1)

    #day2 dates
    start_dt_d2 = datetime(2024, 2, 9, 9, 0, 0)
    end_dt_d2 = datetime(2024, 2, 9, 22, 0, 0)
    scheduler.add_job(id='refresh_scores', func=update_data, trigger='interval', minutes=10, start_date=start_dt_d2, end_date=end_dt_d2)

    #day3 dates
    start_dt_d3 = datetime(2024, 2, 10, 9, 0, 0)
    end_dt_d3 = datetime(2024, 2, 10, 22, 0, 0)
    scheduler.add_job(id='refresh_scores', func=update_data, trigger='interval', minutes=5, start_date=start_dt_d3, end_date=end_dt_d3)

    #day4 dates
    start_dt_d4 = datetime(2024, 2, 11, 9, 0, 0)
    end_dt_d4 = datetime(2024, 2, 11, 22, 0, 0)
    scheduler.add_job(id='refresh_scores', func=update_data, trigger='interval', minutes=2, start_date=start_dt_d4, end_date=end_dt_d4)
